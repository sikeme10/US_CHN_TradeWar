...
names(US)  
US1 <- US1 %>% group_by(hs6_H5,sector) %>% summarise( 
...
plot
ggsave(filename = file.path(exp, "plot/", "Correlation_AVE_FE_WTO_notif.png"),plot = plot, width = 8, height = 5, dpi = 300)
...
plot <- ggplot(merge1, aes(x = diff_ln_AVE_FE_bench, y = count_notif)) +
  ...
  theme(plot.title      = element_text(size = 11, hjust = 0.5),
        ...
        axis.title.y    = element_text(size = 10)  )
plot
ggsave(filename = file.path(exp, "plot/", "Correlation_AVE_FE_bench_WTO_notif.png"),plot = plot, width = 8, height = 5, dpi = 300)
...
plot <- ggplot(merge1, aes(x = diff_ln_AVE_FE, y = coverage_NTM)) +
  ...
  theme(plot.title      = element_text(size = 11, hjust = 0.5),
        ...
        axis.title.y    = element_text(size = 10)  )
plot
ggsave(filename = file.path(exp, "plot/", "Correlation_AVE_FE_NTM_coverage.png"),plot = plot, width = 8, height = 5, dpi = 300)
...
plot <- ggplot(merge1, aes(x = diff_ln_AVE_FE_bench, y = coverage_NTM)) +
  ...
  theme(plot.title      = element_text(size = 11, hjust = 0.5),
        ...
        axis.title.y    = element_text(size = 10)  )
plot
ggsave(filename = file.path(exp, "plot/", "Correlation_AVE_FE_bench_NTM_coverage.png"),plot = plot, width = 8, height = 5, dpi = 300)
...
vars <- vars %>%  rename( FE = diff_ln_AVE_FE,
