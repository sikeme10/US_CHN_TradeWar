...
# Table
tbl <- etable(AVE_2017, AVE_2017_tar, AVE_2017_sector, AVE_2017_sector_interact,
              headers = c("AVE", "with tariff", "sector", "interact"),
              digits = 4,
              fitstat = ~ n + r2 + ar2 + f + f.p + rmse)
tbl
write.csv(tbl, paste0(exp, "SOE_NTM_2017.csv"), row.names = FALSE)
...
# Table
tbl_w <- etable(AVE_2017, AVE_2017_tar, AVE_2017_sector, AVE_2017_sector_interact,
              headers = c("AVE", "with tariff", "sector", "interact"),
              digits = 4,
              fitstat = ~ n + r2 + ar2 + f + f.p + rmse)
tbl_w
