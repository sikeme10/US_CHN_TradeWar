...
write_csv(estimated_tau2_h4,  paste0("data/created_exposure/tau/import_tau_", quant, "_IV.csv"))
write_csv(estimated_tau2_h4_year,  paste0("data/created_exposure/tau/import_tau_year_", quant, "_IV.csv"))
