...
estimated_tau_IV <- estimated_tau_IV %>% select(year, hs2, hs4, predicted_diff_ln_AVE_FE_wmean)

estimated_tau2 <- left_join(estimated_tau1, estimated_tau_IV, by = c("year", "hs2", "hs4"))
...
estimated_tau3 <- full_join(estimated_tau2,tariffs )
...
write_csv(estimated_tau2_h4,  paste0("data/created_exposure/tau/import_CHN_tau_", quant, "_IV.csv"))
write_csv(estimated_tau2_h4_year,  paste0("data/created_exposure/tau/import_CHN_tau_year_", quant, "_IV.csv"))
# 
# 
# ################################################################################
