...
write_csv(RET_tot_r, paste0("/data/sikeme/TRADE/US_CHN_TradeWar_git/data/created_exposure/NAICS6/RET_r_industry_totlabor_IV.csv") )
...
write_csv(RET_sect_r, paste0("/data/sikeme/TRADE/US_CHN_TradeWar_git/data/created_exposure/NAICS6/RET_r_industry_labor_IV.csv") )
...
write_csv(RET_sub_tot_r, paste0("/data/sikeme/TRADE/US_CHN_TradeWar_git/data/created_exposure/NAICS6/RET_r_subsectors_IV.csv") )
