...
exp <- "/data/sikeme/TRADE/US_CHN_TradeWar_git/output/summary/exposure_maps/schott/"


################################################################################ 

dta <- read_csv("/data/sikeme/TRADE/US_CHN_TradeWar_git/data/created_exposure/NAICS6/RET_r_CHN_naics6_schott_IV.csv")
summary(dta)
names(dta)
