...
names(merge_data1)
IMP_tot_r <- merge_data1 %>% group_by(year, czone_2012, subsector) %>% 
...
write_csv(IMP_tot_r, paste0("/data/sikeme/TRADE/US_CHN_TradeWar_git/data/created_exposure/NAICS6/IMP_r_subsectors_IV.csv") )
