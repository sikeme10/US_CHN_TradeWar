...
HS_NAICS <- read_csv("/data/sikeme/TRADE/US_CHN_TradeWar_git/data/crosswalk/clean_HS6_naics6_schott_2012.csv")


# Load tariff data
tariff <- read_csv("/data/sikeme/TRADE/US_CHN_TradeWar_git/data/created_exposure/tau/import_CHN_tau_year_0.05_IV.csv")
...
write_csv(Merge1, paste0(exp, "/gamma_iju_naics6_schott_IV.csv"))
write_csv(Merge_CHN, paste0(exp, "/RET_i_CHN_naics6_schott_IV.csv"))
