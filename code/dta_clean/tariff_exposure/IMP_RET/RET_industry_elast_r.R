...
names(merge_data)
RET_tot_r <- merge_data %>% group_by(year, czone_2012, sector) %>% 
...
write_csv(RET_tot_r, paste0("/data/sikeme/TRADE/US_CHN_TradeWar_git/data/created_exposure/NAICS6/RET_elast_r_industry_totlabor_IV.csv") )
...
write_csv(RET_sect_r, paste0("/data/sikeme/TRADE/US_CHN_TradeWar_git/data/created_exposure/NAICS6/RET_elast_r_industry_labor_IV.csv") )
...
# a) aggregate at CZ level: get REP_r
names(merge_data1)
RET_sub_tot_r <- merge_data1 %>% group_by(year, czone_2012, subsector) %>% 
  summarise(RET_tariff_tot_r = sum(RET_tariff_tot_ir, na.rm = TRUE),
            RET_NTB_tot_r = sum(RET_NTB_tot_ir, na.rm = TRUE),
            RET_NTB_tot_IV_r = sum(RET_NTB_tot_ir_IV, na.rm = TRUE))
...
write_csv(RET_sub_tot_r, paste0("/data/sikeme/TRADE/US_CHN_TradeWar_git/data/created_exposure/NAICS6/RET_elast_r_subsectors_IV.csv") )
