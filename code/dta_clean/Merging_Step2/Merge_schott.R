...
IMP <- read_csv("/data/sikeme/TRADE/US_CHN_TradeWar_git/data/created_exposure/NAICS6/IMP_r_CHN_naics6_schott.csv")
names(IMP)

# RET <-  read_csv("/data/sikeme/TRADE/US_CHN_TradeWar_git/data/created_exposure/NAICS6/RET_r_CHN_naics6.csv")
RET <-  read_csv("/data/sikeme/TRADE/US_CHN_TradeWar_git/data/created_exposure/NAICS6/RET_r_CHN_naics6_schott_IV.csv")
...
write_csv(merge, "/data/sikeme/TRADE/US_CHN_TradeWar_git/data/Pop_reg_dta/merge_schott.csv")
