...
RET_tot_industry <- read_csv("/data/sikeme/TRADE/US_CHN_TradeWar_git/data/created_exposure/NAICS6/RET_r_subsectors_IV.csv")
...
write_csv(merge2, "/data/sikeme/TRADE/US_CHN_TradeWar_git/data/Pop_reg_dta/merge_subsector.csv")
