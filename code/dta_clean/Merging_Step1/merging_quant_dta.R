...
# trade data 
trade <- read_csv("data/trade/GTA_CHN_import/CHN_import_quant_2015_2020.csv")
names(trade)
...
dta <- dta %>%  select(hs6_H5,year, month,ExporterISO3,  ImporterISO3,
  `HS6 Description`,  hs6_H4,  Trade_value_USD, Quantity, Unit_Price)
...
# save data
write_csv(dta1, paste0(exp, "dta_CHN_gravity1_quant.csv"))
...
# import back data 
dta1 <- read_csv(paste0(exp, "dta_CHN_gravity1_quant.csv"))
...
write_csv(dta2, paste0(exp, "dta_CHN_gravity2_quant.csv"))

################################################################################
# 5) Merge with US tariffs
################################################################################

dta2 <- read_csv(paste0(exp, "dta_CHN_gravity2_quant.csv"))
...
# save final data
write_csv(dta2, paste0(exp, "dta_CHN_gravity_3_quant.csv"))

################################################################################
dta2 <- read_csv(paste0(exp, "dta_CHN_gravity_3_quant.csv"))
